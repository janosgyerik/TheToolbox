		...
		<div id="masonry">
			...
			<div class="item normal" data-order='1'>
				...
				<div <?php post_class(); ?> id="featured-<?php the_ID(); ?>">
					...
					<h2 class="post-title"><a href="<?php echo $tool_url; ?>"><?php the_title(); ?><span class="plus"><span>+</span> </span></a></h2>
					...
					<a class="read-more" href="<?php echo $tool_url; ?>"><?php _e('Read More', 'engine'); ?><span class="plus"><span>+</span> </span></a>
